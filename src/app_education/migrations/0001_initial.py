    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gpa', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='GPA')),
                ('field_of_study', models.CharField(blank=True, max_length=50, null=True, verbose_name='Field Of Study')),
                ('university', models.CharField(blank=True, max_length=50, null=True, verbose_name='University')),
            ],
            options={
