...
class HighSchoolTestCase(TestEducationSetUp):
    ...
    def create_test(self):
        ...
        self.assertEqual(self.success_high_school_obj.date_of_graduation, data['date_of_graduation'])
        self.assertEqual(self.success_high_school_obj.gpa, data['gpa'])
        self.assertEqual(self.success_high_school_obj.field_of_study, data['field_of_study'])
