    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tracking_id', models.CharField(max_length=12, unique=True, verbose_name='Tracking ID')),
                ...
                ('status', models.CharField(choices=[('NOCO', 'Not Completed'), ('CRNT', 'Current'), ('ACPT', 'Accepted'), ('RJCT', 'Rejected'), ('NTET', 'NeedToEdit')], default='NOCO', max_length=4, verbose_name='Status')),
                ('degree', models.CharField(choices=[('Bachelor', 'Bachelor'), ('Master', 'Master'), ('P.H.D', 'P.H.D')], default='Bachelor', max_length=8, verbose_name='Degree')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(auto_now_add=True, verbose_name='Created Time')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated Time')),
                ('curriculum_vitae', models.FileField(blank=True, null=True, upload_to=app_application.models.documents.document_image_directory_path, validators=[utils.validators.validate_image_file], verbose_name='Curriculum Vitae')),
                ('personal_photo', models.FileField(blank=True, null=True, upload_to=app_application.models.documents.document_image_directory_path, validators=[utils.validators.validate_image_file], verbose_name='Personal photo')),
                ('valid_passport', models.FileField(blank=True, null=True, upload_to=app_application.models.documents.document_image_directory_path, validators=[utils.validators.validate_image_file], verbose_name='Valid')),
                ('high_school_certificate', models.FileField(blank=True, null=True, upload_to=app_application.models.documents.document_image_directory_path, validators=[utils.validators.validate_image_file], verbose_name='High School Certificate')),
                ('trans_script_high_school_certificate', models.FileField(blank=True, null=True, upload_to=app_application.models.documents.document_image_directory_path, validators=[utils.validators.validate_image_file], verbose_name='Trans Script High School Certificate')),
                ('bachelor_degree', models.FileField(blank=True, null=True, upload_to=app_application.models.documents.document_image_directory_path, validators=[utils.validators.validate_image_file], verbose_name='Bachelor Degree')),
                ('trans_script_bachelor_degree', models.FileField(blank=True, null=True, upload_to=app_application.models.documents.document_image_directory_path, validators=[utils.validators.validate_image_file], verbose_name='Trans Script Bachelor Degree')),
                ('master_degree', models.FileField(blank=True, null=True, upload_to=app_application.models.documents.document_image_directory_path, validators=[utils.validators.validate_image_file], verbose_name='Master Degree')),
                ('trans_script_master_degree', models.FileField(blank=True, null=True, upload_to=app_application.models.documents.document_image_directory_path, validators=[utils.validators.validate_image_file], verbose_name='Trans Script Master Degree')),
                ('supporting_letter', models.FileField(blank=True, null=True, upload_to=app_application.models.documents.document_image_directory_path, validators=[utils.validators.validate_image_file], verbose_name='Supporting Letter')),
            ],
            options={
